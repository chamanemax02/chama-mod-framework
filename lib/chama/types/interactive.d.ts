 ...
 */
export type NativeFlowButtonName = 'quick_reply' | 'cta_url' | 'cta_call' | 'cta_copy' | 'single_select' | 'cta_reminder' | 'review_and_pay' | 'galaxy_message' | 'payment_method' | 'open_webview';
...
export type NativeButtonParams = QuickReplyButtonParams | CtaUrlButtonParams | CtaCallButtonParams | CtaCopyButtonParams | SingleSelectButtonParams | Record<string, unknown>;
