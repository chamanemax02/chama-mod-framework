...
export const LANGUAGE_KEYWORDS = {
    javascript: new Set(['const', 'let', 'var', 'function', 'return', 'if', 'else', 'for', 'while', 'import', 'export', 'from', 'async', 'await', 'class', 'try', 'catch', 'throw', 'new']),
    python: new Set(['def', 'return', 'if', 'elif', 'else', 'for', 'while', 'import', 'from', 'as', 'class', 'try', 'except', 'raise', 'with', 'lambda', 'True', 'False', 'None'])
};
