...
export class RtpPacketizer {
  ...
  constructor(payloadType = 96, clockRate = 90000, ssrc?: number) {
   ...
   * +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
   */
  public packetize(payload: Buffer | Uint8Array, marker = false, timeIncrement = 3000): Buffer {
   ...
   */
  public packetizeVP8(frameChunk: Buffer, isKeyFrame = false, isFirstChunk = true, isLastChunk = true): Buffer {
