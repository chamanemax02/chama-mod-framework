...
export interface BaseSendOptions {
  quoted?: WAMessage | { key: WAMessageKey; message?: proto.IMessage };
...
export interface SendAlbumOptions extends BaseSendOptions {
  images?: Array<Buffer | Uint8Array | { url: string }>;
  videos?: Array<Buffer | Uint8Array | { url: string }>;
  caption?: string;
}
...
export interface PinMessageOptions {
  durationSeconds?: number; // Defaults to 24h (86400) or 7 days or 30 days
}
